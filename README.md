...
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.coveragePopulations`.\n")
.append("       - Find objects where `coverageOptionType = 'MD'`.\n")
.append("       - Extract `coveragePopulationID` from those objects.\n")
.append("       - Assign the extracted value to `MD_CoveragePopulationID`.\n")
.append("       - **If `derivedFields.coveragePopulation` exists, set `MD_CoveragePopulationID` to NULL.**\n\n")
.append("   11.2 **DN_CoveragePopulationID:**\n")
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.coveragePopulations`.\n")
.append("       - Find objects where `coverageOptionType = 'DN'`.\n")
.append("       - Extract `coveragePopulationID` from those objects.\n")
.append("       - Assign the extracted value to `DN_CoveragePopulationID`.\n")
.append("       - **If `derivedFields.coveragePopulation` exists, set `DN_CoveragePopulationID` to NULL.**\n\n")
.append("   11.3 **VS_CoveragePopulationID:**\n")
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.coveragePopulations`.\n")
.append("       - Find objects where `coverageOptionType = 'VS'`.\n")
.append("       - Extract `coveragePopulationID` from those objects.\n")
.append("       - Assign the extracted value to `VS_CoveragePopulationID`.\n")
.append("       - **If `derivedFields.coveragePopulation` exists, set `VS_CoveragePopulationID` to NULL.**\n\n")
...
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.billGroups`.\n")
.append("       - Find objects where `coverageOptionType = 'MD'`.\n")
.append("       - Extract `billGroupReferenceID` from those objects.\n")
.append("       - Assign the extracted value to `MD_BillGroupReferenceID`.\n")
.append("       - **If `derivedFields.billGroup` exists, set `MD_BillGroupReferenceID` to NULL.**\n\n")
.append("   12.2 **DN_BillGroupReferenceID:**\n")
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.billGroups`.\n")
.append("       - Find objects where `coverageOptionType = 'DN'`.\n")
.append("       - Extract `billGroupReferenceID` from those objects.\n")
.append("       - Assign the extracted value to `DN_BillGroupReferenceID`.\n")
.append("       - **If `derivedFields.billGroup` exists, set `DN_BillGroupReferenceID` to NULL.**\n\n")
.append("   12.3 **VS_BillGroupReferenceID:**\n")
.append("       - Parse `referenceDataJSON`.\n")
.append("       - Navigate to `planData.billGroups`.\n")
.append("       - Find objects where `coverageOptionType = 'VS'`.\n")
.append("       - Extract `billGroupReferenceID` from those objects.\n")
.append("       - Assign the extracted value to `VS_BillGroupReferenceID`.\n")
.append("       - **If `derivedFields.billGroup` exists, set `VS_BillGroupReferenceID` to NULL.**\n\n")
.append("   12.4 **Validation Rules:**\n")
.append("       - Ensure all members of the same family have the same `BillGroupReferenceID`.\n")
.append("       - Spouse/child cannot have values that the subscriber lacks.\n")
